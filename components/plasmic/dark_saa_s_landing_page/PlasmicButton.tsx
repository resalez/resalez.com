...
import sty from "./PlasmicButton.module.css"; // plasmic-import: -iZ-8DLVp5gH/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__kqw1M)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___9QYVa)}
                role={"img"}
              />
            ),
